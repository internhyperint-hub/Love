    ...
    return (
        <div className=" bg-gray-50 p-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold text-center mb-2 text-gray-800">So luv Jewelry Collection</h1>
                <p className="text-center text-gray-600 mb-8">Premium handcrafted jewelry made with love and attention to detail</p>

                <div className="flex justify-center gap-2">
                    {reviews.map((review) => (
                        <div
                            key={review.id}
                            className="w-[120px] relative rounded-md overflow-hidden cursor-pointer transform hover:scale-105 transition-all duration-300 group"
                        ...
                        >
                            ...
                            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center p-3" style={{ backgroundColor: '#fbdb8d' }}>
                                <div className="flex justify-center mb-2">
                                    {renderStars(review.rating, false)}
                                </div>
                                <h3 className="text-sm font-semibold text-center mb-1" style={{ color: '#A82E61' }}>{review.name}</h3>
                                <p className="text-xs text-center mb-1" style={{ color: '#A82E61' }}>{review.location}</p>
                ...
                {selectedReview && (
                    <div className="fixed inset-0 backdrop-blur-sm bg-transparent flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
                            {/* Header */}
                            <div className="text-white p-3 flex justify-between items-center" style={{ backgroundColor: '#A82E61' }}>
                                <h2 className="text-lg font-semibold">Customer Showcase</h2>
                                <button
                                    onClick={closeModal}
                            ...
                            <div className="p-4">
                                <div className="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div className="md:w-2/3">
                                        ...
                                        <div className="bg-pink-50 border-l-4 border-pink-300 p-3 rounded">
                                        ...
                                        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                                            <h5 className="text-sm font-semibold text-gray-800 mb-1">About So luv</h5>
